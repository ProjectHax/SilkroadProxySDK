...
/*
	All Unicode functions have been removed due to most Unix operating systems
	having 4 bytes (UTF-32) for a wchar_t instead of 2 (UTF-16). Silkroad runs on
	Windows so it uses UTF-16. Support can be re-added by using a conversion library
	to convert from UTF-32 to UTF-16. Qt can do this easily.

	Unicode is not really necessary for Silkroad unless you plan to inject chat
	packets.
*/
